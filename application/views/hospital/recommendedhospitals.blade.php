<table>
                ...
                <td class="span30 bold">&nbsp;</td>
                 ...
                 @foreach ($recommendedHosps as $key=>$hospitals)
                 <tbody>
                <tr>
                ...
                <td><img src="img/physician/like.gif" alt="like button" title="like button" onclick="connect_hospital('{{$hospitals->id}}','hospital','like')"></td>
